...
<div class="hero-copy"><p class="eyebrow"><span class="small-line"></span> Making your financial goals easier</p><h1>Financial support for <em>your next move</em></h1><p class="lead">Whether you’re a salary earner or a business owner, start your loan application with Nomisma.</p>
...
form.addEventListener("submit", async (event) => {
  ...
  try {
    ...
    status.textContent = "Your loan application has been received.";
