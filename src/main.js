...
<div class="hero-copy"><h1>Making your <em>financial goals easier</em></h1><p class="lead">Whether you’re a salary earner or a business owner, start your loan application with Nomisma.</p>
...
<div id="success" hidden tabindex="-1"><div class="success-icon" aria-hidden="true">✓</div><p>To further your loan application . . .</p><a id="success-whatsapp" class="button primary" target="_blank" rel="noopener noreferrer">${chat}Continue on WhatsApp</a><p class="small">You can also choose to wait for our team to contact you.</p></div>
</section></div></section>
